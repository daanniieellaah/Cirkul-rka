...
const CirkularniEkonomika = () => {
  return (
    <div className="container--cirkulareko">
      ...
      Trend cirkulární ekonomiky reaguje na současný model lineární ekonomiky a zároveň nabízí alternativu v podobě ekonomicky i ekologicky výhodného řešení, kdy i použité či staré věci mohou stále přinášet užitek.
